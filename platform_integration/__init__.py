...
cut_url = 'https://jsonplaceholder.typicode.com/photos' # api de exemplo para testes
globo_play_url = 'https://jsonplaceholder.typicode.com/posts'
c = Client(cut_url, globo_play_url) # instancia a class do http client
# cria o gerenciador de eventos
event_handler = DirEventHandler(tp, path, c)